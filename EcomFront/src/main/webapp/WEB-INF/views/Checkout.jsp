	...
	<div class="container">
		<div class='row'>
			...
			<div class='col-md-4'>
				...
				<div class='form-row'>
					&nbsp;&nbsp;<label class='control-label'>First Name: </label>&nbsp;${registrationForm.first_name}
				</div>
				<div class='form-row'>
					&nbsp;&nbsp;<label class='control-label'>Last Name: </label>&nbsp;${registrationForm.last_name}
				</div>
				<div class='form-row'>
					&nbsp;&nbsp;<label class='control-label'>Email: </label>&nbsp;${registrationForm.email}
				</div>
				<div class='form-row'>
					&nbsp;&nbsp;<label class='control-label'>Phone: </label>&nbsp;${registrationForm.contact_info}
				</div>
				<div class='form-row'>
